...
public class Lab2P1_JoseAlvarez {
    public static void main(String[] args) {
       Scanner leer = new Scanner(System.in);
        ...
        if (opcion == 1) {
            System.out.println("Ingrese la primera medida de su triángulo: ");
            double num1 = leer.nextDouble();
            System.out.println("Ingrese la segunda medida de su triángulo: ");
            double num2 = leer.nextDouble();
            System.out.println("Ingrese la tercera medida de su triángulo: ");
